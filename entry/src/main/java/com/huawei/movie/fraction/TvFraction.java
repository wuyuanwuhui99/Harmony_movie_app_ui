    ...
    protected void onStart(Intent intent) {
        ...
        getFractionAbility().getUITaskDispatcher().asyncDispatch(()-> {
            getFractionAbility().getFractionManager()
                    ...
                    .add(ResourceTable.Id_tv_avater_wrapper, new AvaterFraction())
                    .add(ResourceTable.Id_tv_avater_wrapper,new SearchFraction("电视剧"))
                    .add(ResourceTable.Id_tv_swriper_wrapper,new SwiperFraction("电视剧"))
                    .submit();
        });
                ...
                getContext().getUITaskDispatcher().asyncDispatch(()->{
                    getFractionAbility().getUITaskDispatcher().asyncDispatch(()-> {
                        ...
                        for (CategoyEntity categoyEntity:categoyEntityList){
                            fractionScheduler.add(ResourceTable.Id_tv_category_list,new CategoryFraction(categoyEntity));
                        }
